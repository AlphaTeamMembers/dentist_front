var Datepicker = (function () {
  ...
  function q(t, s) {
    ...
    if (a.language) {
      ...
      if (
        ...
        (c = Object.assign({ format: H, weekStart: $ }, r[T])),
          ...
          g === t.weekStart &&
            ((g = n.weekStart = c.weekStart), (n.weekEnd = _(c.weekStart)));
      }
    }
    if (a.format) {
    ...
    if (
      (void 0 !== a.minDate &&
        ((y = null === a.minDate ? l(0, 0, 1) : P(a.minDate, d, c, y)),
        delete a.minDate),
      void 0 !== a.maxDate &&
        ((k = null === a.maxDate ? void 0 : P(a.maxDate, d, c, k)),
        delete a.maxDate),
      k < y
    ...
    if (void 0 !== a.weekStart) {
      ...
      isNaN(e) || ((g = n.weekStart = e), (n.weekEnd = _(e))),
        delete a.weekStart;
    }
    if (
      (a.daysOfWeekDisabled &&
        ((n.daysOfWeekDisabled = a.daysOfWeekDisabled.reduce(j, [])),
        delete a.daysOfWeekDisabled),
      a.daysOfWeekHighlighted &&
        ((n.daysOfWeekHighlighted = a.daysOfWeekHighlighted.reduce(j, [])),
  ...
  function ne(t, i) {
    if (
      (void 0 !== i.title &&
        (i.title
          ? ((t.controls.title.textContent = i.title), A(t.controls.title))
    ...
    if (
      ...
      void 0 !== i.todayBtn &&
        (i.todayBtn ? A(t.controls.todayBtn) : W(t.controls.todayBtn)),
    ...
    void 0 !== i.clearBtn &&
      (i.clearBtn ? A(t.controls.clearBtn) : W(t.controls.clearBtn));
  }
  function re(e) {
    ...
    let o = t.reduce((e, t) => {
      ...
      if (s.pickLevel > 0) {
        ...
        i =
          1 === s.pickLevel
            ? d
              ? e.setMonth(e.getMonth() + 1, 1) - 864e5
              : e.setDate(1)
            : d
            ? e.setFullYear(e.getFullYear() + 1, 0, 1) - 864e5
            : e.setMonth(0, 1);
      }
      return (
